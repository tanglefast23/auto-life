...
const FirstSessionStringsSchema = z.strictObject({
  ...
  recap: z.strictObject({
    ...
    practiceSessions: z.string().min(1),
    ...
    needsHeading: z.string().min(1),
    needsFirstDay: z.string().min(1),
    needsCompared: z.string().min(1),
    needsUnavailable: z.string().min(1),
    wrinkleHeading: z.string().min(1),
    wrinkleNone: z.string().min(1),
    goalsHeading: z.string().min(1),
    goalsNone: z.string().min(1),
    rewardsHeading: z.string().min(1),
    rewardsNone: z.string().min(1),
    journalHeading: z.string().min(1),
    journalNone: z.string().min(1),
    details: z.string().min(1),
    less: z.string().min(1),
    done: z.string().min(1),
    announcement: z.string().min(1),
  }),
  fatal: z.strictObject({
    title: z.string().min(1),
    body: z.string().min(1),
  }),
});
